...
**当前授权**：产品负责人已单独授权且仅授权 F0-A1 Rust Runtime Bootstrap；该切片已实现且独立 Critical 实现审查已 ACCEPT，当前等待产品负责人验收，尚未 owner-accepted。F0-A2、F0-A3、F1 与 I1-I6 产品实现仍暂停。
...
- 产品负责人已单独授权且仅授权 F0-A1；该切片已实现且独立 Critical 实现审查已 ACCEPT，当前等待产品负责人验收，尚未 owner-accepted。F0-A2、F0-A3、F1 与全部产品实现当前仍暂停；本表只规定未来获授权后的顺序，不构成这些阶段的开工授权。
